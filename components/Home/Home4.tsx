...
function Home4() {
    return (
        <div className='flex items-center justify-around md:flex-row-reverse flex-col h-fit w-full mt-11 border-4 border-purple-800 rounded-md'>
            <img src='/asdf.png' className='md:w-auto md:h-full w-full h-auto ' />
            <div className='md:w-[50%] lg:w-[30%] h-full flex flex-col items-center justify-center g'>
                <span className='w-full h-auto text-3xl text-blue-900 font-bold lg:px-6 text-center 0 py-8 '>
